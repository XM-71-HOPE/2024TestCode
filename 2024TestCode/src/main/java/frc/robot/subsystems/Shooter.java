...
public class Shooter extends SubsystemBase{
    ...
    private static TalonFX m_ShooterLeft = new TalonFX(ShooterConstants.ShooterLeft_ID,"rio");
    private static TalonFX m_ShooterRight = new TalonFX(ShooterConstants.ShooterRight_ID,"rio");
    ...
    public boolean IsAtTargetRPS(){
        ...
        && Math.abs(GetRighttRPS()-GetTargetRPS())<ShooterConstants.ShooterSpeedTolerence;
    }
